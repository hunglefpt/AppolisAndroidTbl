/**
 * Name: $RCSfile: CommandContext.java,v $
...
class CommandContext {
	...
	public CommandContext(boolean getOperation,ISktScanObject scanObj,ISktScanDevice scanDevice,DeviceInfo deviceInfo,ICommandContextCallback callback){
