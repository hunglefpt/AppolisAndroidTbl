/**
 * Name: $RCSfile: ObjectCycleItem.java,v $
...
public class ObjectCycleItem {
	private boolean _LotTrackingInd;
	private int _uomTypeID;
	private boolean _expirationDate;
	...
	public boolean is_expirationDate() {
		return _expirationDate;
	}

	public void set_expirationDate(boolean _expirationDate) {
